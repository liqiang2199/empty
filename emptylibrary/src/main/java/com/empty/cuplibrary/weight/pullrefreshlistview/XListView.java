package com.empty.cuplibrary.weight.pullrefreshlistview;
...
//	}
	...
	private void startLoadMore() {
		...
		if (mListViewListener != null) {
			...
			Log.d("startLoadMore", "startLoadMore");
		}
	}
...
//				System.out.println("deltaY="+deltaY);
	...
	public void startHeaderRefresh(){
		updateHeaderHeight(getResources().getDimension(R.dimen.xlistview_headhight)/ OFFSET_RADIO);
		invokeOnScrolling();
		mPullRefreshing =true;
		mHeaderView.setState(XListViewHeader.STATE_REFRESHING);
		if (mListViewListener != null) {
	...
	public interface IXListViewListener {
		public void onRefresh();  // 重写此方法进行数据刷新 请求数据
