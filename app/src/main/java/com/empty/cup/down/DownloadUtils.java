...
public class DownloadUtils {
    ...
    private ViewPageJDActivity.OpenApk openApk;
    //下载的ID
    private long downloadId;
    public DownloadUtils(Context context, ViewPageJDActivity.OpenApk openApk){
    ...
    public void downloadAPK(String url, String name) {
        ...
        request.setTitle("QF_r");
//        request.setDescription("Apk Downloading");
        request.setVisibleInDownloadsUi(true);

        //设置下载的路径
//        request.setDestinationInExternalPublicDir(Environment.getExternalStorageDirectory().getAbsolutePath() , name);
        request.setDestinationInExternalFilesDir(mContext,Environment.getExternalStorageDirectory().getAbsolutePath() , name);
